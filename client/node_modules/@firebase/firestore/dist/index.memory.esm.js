...
var E = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new T(E.ABORTED, "getToken aborted due to token change.");
            return n ? (Ve("string" == typeof n.accessToken), new A(n.accessToken, t.currentUser)) : null;
    ...
    n.G = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new T(E.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var L = /^[_a-zA-Z][_a-zA-Z0-9]*$/, M = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.$ = function(t, e, r) {
...
/** A dot-separated path for navigating sub-objects within a document. */ M.H = new M([]);
...
var B = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Q(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return Me(t.arrayValue.values || [], e.arrayValue.values || [], Q);
...
function J(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Le(X(t.latitude), X(e.latitude));
            return 0 !== n ? n : Le(X(t.longitude), X(e.longitude));
...
function H(t, e) {
    ...
    var n = Z(t), r = Z(e), i = Le(n.seconds, r.seconds);
...
function Y(t) {
    return function t(e) {
        ...
        }(e.timestampValue) : "stringValue" in e ? e.stringValue : "bytesValue" in e ? K(e.bytesValue).toBase64() : "referenceValue" in e ? (r = e.referenceValue, 
        U.Z(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function K(t) {
...
var st = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Me(this.elements, e.elements, Q);
    }, t;
}(), ut = /** @class */ function() {
    function t(t) {
        this.elements = t;
...
e) {
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.wt(t) ? new Dt(this.key, V.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var At, It, Nt = function(t, e) {
    ...
    return t.prototype.canonicalId = function() {
        ...
        return U.et(this.path) && null === this.collectionGroup && 0 === this.filters.length;
    }, t;
}(), kt = /** @class */ function() {
    /**
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.Bt) {
                ...
                t.Y() || this.Bt.push(new Ct(t)), this.Bt.push(new Ct(M.X(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.ee = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.tt(this.collectionGroup) && this.path.B(e) : U.et(this.path) ? this.path.isEqual(e) : this.path.U(e);
    }, 
    /**
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        if (nt(r)) {
            if ("==" /* EQUAL */ !== e) throw new T(E.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (rt(r)) {
            if ("==" /* EQUAL */ !== e) throw new T(E.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && z(this.value) === z(e) && this.fe(J(e, this.value));
        ...
        return this.field.j() + this.op.toString() + Y(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && Q(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.j() + " " + this.op + " " + Y(this.value);
    }, n;
}((function() {})), Lt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = U.Z(r.referenceValue), i;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = U.N(t.key, this.key);
        return this.fe(e);
    }, n;
    ...
    t.prototype._e = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? U.N(U.Z(o.referenceValue), e.key) : J(o, e.field(i.field)), 
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.de ? U.N(t.key, e.key) : function(t, e, n) {
            var r = e.field(t), i = n.field(t);
            return null !== r && null !== i ? J(r, i) : Re();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
 ...
 */ function Gt(t) {
    ...
    return _e("GRPC error has no .code"), E.UNKNOWN;
    switch (t) {
      case At.OK:
        return E.OK;
 ...
 */ var oe = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.N = t ? function(e, n) {
            return t(e, n) || U.N(e.key, n.key);
        } : function(t, e) {
            return U.N(t.key, e.key);
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, he.fs(e, n)), new t(V.min(), r, ie(), Yt(), ne());
    }, t;
}(), he = /** @class */ function() {
    function t(
    /**
 ...
 */ var me = {
    ...
    return t.prototype.ni = function(t) {
        var e = void 0 === t.code ? E.UNKNOWN : Gt(t.code);
    ...
    t.prototype.ci = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? S.H : this.Ti(e);
...
function(t, e, n, r, i) {
    ...
    t.prototype.Bn = function(t, e, n) {
        ...
        return this.Nn(t, new U(e)).next((function(t) {
            var e = Kt();
...
var Be = function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.Rr && (this.clearTimeout(), this.mr.reject(new T(E.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
...
var He = /** @class */ function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.k(), r = this.index[e] || new Wt(S.N), i = !r.has(n);
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.lh = V.min(), this.Dn = t._h(n), this.fh = t.dh(), this.Th = t.wh(), this.Eh = new xe(this.fh, this.Dn, this.persistence.mh()), 
        this.oh.Ih(this.Eh)
    ...
    t.prototype.uo = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.ro(o, t.ee()).next((function(t) {
                ...
                return n.oh.Bn(o, t, e ? r : V.min(), e ? i : ne());
            })).next((function(t) {
                return {
                    documents: t,
                    lo: i
...
var $e = /** @class */ function() {
    ...
    t.prototype.Ao = function(t) {
        var e = this, n = U.EMPTY, r = new tn(n, t), i = new tn(n, t + 1), o = [];
        ...
        var e = U.EMPTY, n = new tn(e, t), r = new tn(e, t + 1), i = ne();
    ...
    return t.To = function(t, e) {
        return U.N(t.key, e.key) || Le(t.yo, e.yo);
    }, 
    /** Compare by ID then by key */ t.Eo = function(t, e) {
        return Le(t.yo, e.yo) || U.N(t.key, e.key);
    }, t;
}();
 ...
 */
function en(t, e) {
    if (0 !== e.length) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + wn(e.length, "argument") + ".");
}
 ...
 */ function nn(t, e, n) {
    if (e.length !== n) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires " + wn(n, "argument") + ", but was called with " + wn(e.length, "argument") + ".");
}
 ...
 */ function rn(t, e, n) {
    if (e.length < n) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires at least " + wn(n, "argument") + ", but was called with " + wn(e.length, "argument") + ".");
}
 ...
 */ function on(t, e, n, r) {
    if (e.length < n || e.length > r) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + wn(e.length, "argument") + ".");
}
...
function cn(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = pn(r);
        throw new T(E.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
/** Helper to validate the type of a provided input. */ function fn(t, e, n, r) {
    if (!("object" === e ? ln(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = pn(r);
        throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function dn(t, e, n) {
    if (void 0 === n) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + gn(e) + " argument, but it was undefined.");
}
 ...
 */ function yn(t, e, n) {
    q(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new T(E.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function vn(t, e, n, r) {
    var i = pn(r);
    return new T(E.INVALID_ARGUMENT, "Function " + t + "() requires its " + gn(n) + " argument to be a " + e + ", but it was: " + i);
}

function mn(t, e, n) {
    if (n <= 0) throw new T(E.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + gn(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function En() {
    if (!Ee.nt().bo) throw new T(E.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Tn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new T(E.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new T(E.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + wn(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (sn("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new T(E.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.So = new M(t);
    }
...
var In = new RegExp("[~\\*/\\[\\]]"), Nn = function(t) {
    ...
    return t(n, e), n.prototype.Ci = function(t) {
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new T(E.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
...
/** A "context" object passed around while parsing user data. */ var qn = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Bo = function(e) {
        ...
        return new T(E.INVALID_ARGUMENT, "Function " + this.settings.methodName + "() called with invalid data. " + t + e);
    }, 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.zo = function(t, e, n) {
        ...
        if (n) {
            for (var u = [], a = 0, h = n; a < h.length; a++) {
                ...
                if (!r.contains(f)) throw new T(E.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                zn(u, f) || u.push(f);
            }
...
function xn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R || t instanceof Sn || t instanceof Tn || t instanceof Dr || t instanceof Nn);
}
 ...
 */ function Gn(t, e) {
    ...
    throw new T(E.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function Bn(t, e) {
    try {
        return function(t) {
            if (t.search(In) >= 0) throw new T(E.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (An.bind.apply(An, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new T(E.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).So;
    } catch (e) {
        var n = (i = e) instanceof Error ? i.message : i.toString();
        throw new T(E.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
    /**
 ...
 */ var Qn = /** @class */ function() {
    ...
    return t(n, e), n.prototype.Ia = function(t) {
    ...
    return t(n, e), Object.defineProperty(n.prototype, "ga", {
        /**
    ...
    /** Gets an auth token and invokes the provided RPC. */    return t(n, e), n.prototype.Fa = function(t, e) {
        var n = this;
    ...
    return t.prototype.Ma = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.xa(), this.mutations.length > 0) throw new T(E.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
    ...
    t.prototype.Fu = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                ...
                this._u.lastStreamToken = C.ht, this.Ja.qh(C.ht).catch(Ke)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                // logic kick in.
                return jt(r = t.code) && r !== E.ABORTED ? (e = this.Za.shift(), [ 2 /*return*/ , (this._u.ua(), 
    ...
    return t.prototype.Vc = function() {
        ...
        try {
            ...
            return !F(e) && e.catch && e.then ? e : (this.mr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    void r.reject(new T(E.UNAVAILABLE, "Failed to persist write: " + i))) ];
                    throw i;
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Lc = this.Lc.remove(i), this.kc.delete(t), this.zc(), o = (o = new Bt(U.N)).Re(i, new Dt(i, V.min())), 
                    s = ne().add(i), u = new ae(V.min(), 
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    return [ 2 /*return*/ , void t.onError(new T(E.UNAVAILABLE, u)) ];
    ...
    return t.prototype.Ih = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(V.min()) ? this.Al(t, e) : this.Rl.qn(t, r).next((function(o) {
            var u = i.Pl(e, o);
            return (e.oe() || e.ae()) && i._c(e.xt, u, r, n) ? i.Al(t, e) : (Ae() <= s.DEBUG && Ne("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
    ...
    t.prototype._c = function(t, e, n, r) {
        ...
        return Ae() <= s.DEBUG && Ne("IndexFreeQueryEngine", "Using full collection scan to execute query: %s", e.toString()), 
        this.Rl.Bn(t, e, V.min());
    }, t;
}(), fr = /** @class */ function() {
    function t(t, e) {
        this.Fn = t, this.zh = e, 
    ...
    return t.prototype.yl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                U.et(i) || (i = i.child(""));
        var o = new tn(new U(i), 0), s = new Wt(Le);
    ...
    t.prototype.Gh = function(t) {
        ...
        for (var r = Kt(), i = new U(e.path.child("")), o = this.docs.ve(i)
...
lr.Ll = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.fc = function(t) {
        var e = this, n = [];
...
var pr = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        throw new T(E.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), gr = /** @class */ function() {
    function t(t, e, n, 
    /**
    ...
    t.prototype.v_ = function() {
        if (this.Tr.$r) throw new T(E.FAILED_PRECONDITION, "The client has already been terminated.");
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.v_(), this.Tr.enqueue((function() {
            ...
            throw new T(E.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)");
        }));
...
var Er = /** @class */ function() {
    ...
    return t.prototype.U_ = function(t) {
        ...
        return new Sn(X(t.latitude), X(t.longitude));
    }, t.prototype.H_ = function(t) {
        var e = this;
        ...
        var e = S.G(t);
        Ve(be(e));
        var n = new Oe(e.get(1), e.get(3)), r = new U(e.L(5));
    ...
    function t(t) {
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Je.th; else {
            if (t.cacheSizeBytes !== Tr && t.cacheSizeBytes < Je.Zr) throw new T(E.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Je.Zr);
    ...
    return t.prototype.settings = function(t) {
        ...
        var e = new Ar(t);
        if (this.J_ && !this.if.isEqual(e)) throw new T(E.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.J_) throw new T(E.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.J_ && !this.J_.k_) throw new T(E.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        ...
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new T(E.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */        if (!n || "string" != typeof n) throw new T(E.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.z_) throw new T(E.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.z_;
        },
        enumerable: !0,
        configurable: !0
        ...
        this.X_(), new Mr(S.G(t), this);
    }, t.prototype.doc = function(t) {
        return nn("Firestore.doc", arguments, 1), sn("Firestore.doc", "non-empty string", 1, t), 
        this.X_(), Dr.lf(S.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (nn("Firestore.collectionGroup", arguments, 1), sn("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new T(E.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.X_(), new Sr(new kt(S.H, t), this);
        ...
        t) {
          ...
          default:
            throw new T(E.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.Ef) throw new T(E.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Dr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.lf = function(e, n, r) {
        if (e.length % 2 != 0) throw new T(E.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.j() + " has " + e.length);
        ...
        !t) throw new T(E.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = S.G(t);
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new T(E.INVALID_ARGUMENT, "Invalid value " + pn(r) + " provided to function Query.where() for its " + gn(2) + " argument. Acceptable values: " + e.join(", "));
            return r;
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new T(E.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        if (null !== this.pf.startAt) throw new T(E.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.pf.endAt) throw new T(E.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.Sf = function(t, e, n, r) {
        if (dn(t, 1, e), e instanceof Vr) {
            if (n.length > 0) throw new T(E.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
    ...
    t.prototype.Cf = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.pf.orderBy; r < i.length; r++) {
            ...
            if (o.field.Y()) n.push($(this.firestore.Zo, t.key)); else {
                ...
                if (j(s)) throw new T(E.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
                    throw new T(E.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.Df = function(t, e, n) {
        ...
        var r = this.pf.Mt;
        if (e.length > r.length) throw new T(E.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.Y()) {
                if ("string" != typeof s) throw new T(E.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.pf.le() && -1 !== s.indexOf("/")) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.pf.path.child(S.G(s));
                if (!U.et(u)) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new U(u);
        ...
        if (t.ae() && 0 === t.Mt.length) throw new T(E.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        ...
        var r = this.If({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new T(E.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.gf = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.pf.le() && -1 !== t.indexOf("/")) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.pf.path.child(S.G(t));
            if (!U.et(e)) throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return $(this.firestore.Zo, new U(e));
        }
        if (t instanceof Dr) {
            var n = t;
            return $(this.firestore.Zo, n.ta);
        }
        throw new T(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + pn(t) + ".");
    }, 
    /**
    ...
    t.prototype.yf = function(t, e) {
        ...
        })).length > 0) throw new T(E.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof St) {
            ...
            if (t.ue()) {
                ...
                throw u === t.op ? new T(E.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new T(E.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new T(E.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), Lr = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.Lf.hs) throw new T(E.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, kt.Wt(t), n, r) || this).Mf = t, t.length % 2 != 1) throw new T(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new Dr(new U(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        "" === t) throw new T(E.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = S.G(t);
...
function Ur(t, e) {
    ...
    if (yn(t, e, [ "merge", "mergeFields" ]), hn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + pn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new T(E.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + pn(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof An;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new T(E.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function Pr(t, e, n) {
    if (e instanceof Dr) {
        if (e.firestore !== n) throw new T(E.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
function xr(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new T(E.INVALID_ARGUMENT, t);
    }
...
var jr = xr(Ir, "Use firebase.firestore() instead."), Gr = xr(Nr, "Use firebase.firestore().runTransaction() instead."), Br = xr(_r, "Use firebase.firestore().batch() instead."), zr = xr(Dr, "Use firebase.firestore().doc() instead."), Qr = xr(Vr), Wr = xr(kr), Jr = xr(Sr), Hr = xr(Lr), Yr = xr(Mr, "Use firebase.firestore().collection() instead."), Zr = xr(/** @class */ function() {
    ...
    Commit: "commit"
}, ri = "gl-js/ fire/" + w, ii = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.sd = function(t, e) {
            ...
            u.listenOnce(y.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case v.TIMEOUT:
                        Ne("Connection", 'RPC "' + t + '" timed out'), s(new T(E.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case v.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new T(i, r.message));
                            } else s(new T(E.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        Ne("Connection", 'RPC "' + t + '" failed'), s(new T(E.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.ed, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = m(), i = {
        ...
        return v(g.EventType.OPEN, (function() {
            ...
            d || (d = !0, Ne("Connection", "WebChannel transport errored:", t), y.Zf(new T(E.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    void 0 === u && (u = E.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    d = !0, y.Zf(new T(u, a)), s.close();
...
export { oi as __PRIVATE_registerFirestore };
